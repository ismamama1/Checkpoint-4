...
function ListCards({ image, name, house }) {
  return (
    <div className="w-[45%] md:w-[22%] lg:w-[18%] xl:w-[15%] flex flex-col flex-wrap rounded-lg shadow-lg bg-beige overflow-hidden m-4 h-auto">
      {/* <div className="w-[45%] h-[80%] md:w-[22%] lg:h-[50%] lg:w-[90%] xl:w-[15%] bg-beige rounded overflow-hidden m-8 p-2 text center"> */}
      <img
        className="object-contain w-15 h-50 pb-4"
        src={image}
        alt={name}
        loading="lazy"
      />
