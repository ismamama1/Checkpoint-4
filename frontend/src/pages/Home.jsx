    ...
    <div className="h-max bg-black">
      <section className="flex flex-col justify-between gap-y-28 p-16">
        <img
          src={vinyl}
          alt="vinyl"
          className="w-[14rem] absolute inset-y-60 left-3 md:inset-y-80 md:left-20 xl:inset-y-80 xl:left-40"
        />
        ...
        <img
          src={cd}
          alt="cd"
          className="w-[12rem] absolute inset-y-[33rem] right-3 md:inset-y-[39rem] md:right-20 xl:inset-y-[39rem] xl:right-40"
        />
